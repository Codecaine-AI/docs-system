 ...
 *
 * In static/export mode only `getDocsTree` exists — the mutation-capable
 * methods are omitted entirely, which DocEditor treats as "no lock
 * management" (moot anyway: static builds never render the editor).
 */
