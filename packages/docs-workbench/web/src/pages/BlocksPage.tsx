 ...
 * block type, rendered from real DocDocument fragments through the same
 ...
 *
 * The outer div is the page's scroll container; the library's type sidebar
 * sticks to its top (`lg:sticky`) and scrolls independently, so keep the
 * overflow on this wrapper rather than on anything inside the library.
 */
