...
export function openDiagram(document: any, kind: string, title?: string, view?: string, onClose?: () => void) {
  ...
  const props={id:document.id,initialDocument:document,initiallyOpen:true,title,onViewerClose:close};
