 ...
 * markdown bridges, the markdown projection, annotation sidecar schema, and
 * the SpectreRef reference shape. Extracted from Spectre
 * apps/frontend/src/lib/docs-model (block-registry.ts, which imports React
...
export * from "./annotations-schema";
