...
const CORPUS_PATHS = [
  ...
  "docs/30-implementation/doc.json",
  "docs/30-implementation/10-packages/doc.json",
  "docs/30-implementation/10-packages/10-docs-model/doc.json",
  "docs/30-implementation/10-packages/20-docs-index/doc.json",
  "docs/30-implementation/10-packages/30-docs-server/doc.json",
  "docs/30-implementation/10-packages/40-docs-viewer/doc.json",
  "docs/30-implementation/10-packages/50-docs-workbench/doc.json",
  "docs/30-implementation/10-packages/60-docs-cli/doc.json",
  "docs/30-implementation/10-packages/70-framework/doc.json",
  "docs/30-implementation/10-packages/80-external-canvas/doc.json",
  "docs/30-implementation/20-workbench/doc.json",
  "docs/30-implementation/30-save-pipeline/doc.json",
  "docs/30-implementation/40-theming/doc.json",
  "docs/30-implementation/40-theming/10-global-themes/doc.json",
  "docs/30-implementation/40-theming/20-component-themes/doc.json",
  "docs/30-implementation/40-theming/30-fonts/doc.json",
  "docs/30-implementation/40-theming/40-system-ui/doc.json",
  "docs/30-implementation/99-appendix/00-local-dev-loop/doc.json",
] as const;
