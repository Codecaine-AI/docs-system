...
const CORPUS_PATHS = [
  ...
  "docs/10-system-design/10-doc-standards/70-document-purpose/doc.json",
  "docs/10-system-design/10-doc-standards/80-authoring-lints/doc.json",
  ...
  "docs/10-system-design/40-block-vocabulary/10-rich-text/18-html/doc.json",
  ...
  "docs/30-implementation/40-theming/10-system-ui/doc.json",
