...
| --- | --- | --- | --- |
| tone | "info" / "decision" / "risk" / "warning" / "success" | no | Color/intent; the projection label falls back to the uppercased tone (default INFO). |
| kind | string | no | Free-form label chip; wins over tone in the projection. Coerced legacy types land their old type name here. |
