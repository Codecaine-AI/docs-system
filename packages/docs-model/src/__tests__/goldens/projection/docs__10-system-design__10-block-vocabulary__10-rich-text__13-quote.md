...
- In projection output, quote lines share the `> ` prefix with callout, mermaid, and video projections; grep for `> \*\*` to isolate the labeled families from plain quotes.
