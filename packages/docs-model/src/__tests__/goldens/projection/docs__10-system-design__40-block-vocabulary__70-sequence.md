...
- Workbench host
  ...
  - The inline preview opens a full-screen viewer with Fit and zoom controls. Opening grows from the preview over 260 milliseconds. Close or Escape returns over 220 milliseconds, then restores document scrolling and focus. Reduced-motion preferences disable the transitions. Published pages use the same motion from their existing preview.
