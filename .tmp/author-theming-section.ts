...
buildDoc("10-global-themes", "global-themes", "Global themes", [
  ...
  [
    "intro",
    {
      ...
      props: {},
      text: [
        t("A theme is a folder. Global built-ins (Default and Dark — the catalogue stays minimal while the theme identity is still being figured out) are compiled into the workbench; custom themes live in the repo's "),
        c("themes/<id>/"),
        ...
        t(`// themes/example/theme.json
{
  ...
  [
    "saveas-rail",
    {
      ...
      props: {},
      text: [
        t("From the rail: Save current look as theme snapshots your knobs (base = the active theme) into a new "),
        c("themes/<id>/"),
        t(" folder via "),
        c("POST /api/themes"),
        t("."),
